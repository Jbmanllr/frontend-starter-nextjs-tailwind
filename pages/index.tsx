...
const Home: React.FC = () => {
  ...
  <div className="max-w-7xl mx-auto">
    <div className="relative group">
      ...
      {people.map((person) => (
        <li key={person.email} className="col-span-1 divide-y divide-gray-200 rounded-lg bg-white dark:bg-slate-800 dark:highlight-white/5 shadow">
          <div className="flex w-full items-center justify-between space-x-6 p-6">
            <div className="flex-1 truncate">
              ...
              <p className="mt-1 truncate text-sm text-gray-500 dark:text-slate-400">{person.title}</p>
            </div>
