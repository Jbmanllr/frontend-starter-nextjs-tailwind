...
import { Menu, Transition, Combobox, Tab, Dialog } from '@headlessui/react'
...
const Demo: React.FC = () => {
  ...
  const [sidebarOpen, setSidebarOpen] = useState(false)
    ...
    console.log('SELECTED COMBOBOX', selected)
    ...
    return (
        ...
        <div className="flex flex-1 flex-col md:pl-64">
          <div className="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-white shadow">
            ...
            <div className="w-72 my-5 bg-gradient-to-r from-indigo-500">
