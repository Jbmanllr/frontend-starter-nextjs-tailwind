...
const Footer: FC<Props> = ({ className }) => {
  ...
  return (
    <footer className={cn('bg-slate-900 dark:bg-slate-800', className)} aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-screen-xl py-12 px-4 sm:px-6 lg:py-12 lg:px-8">
        <div className="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
            <div className="grid grid-cols-2 gap-8 xl:col-span-4">
            <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                <h3 className="text-base font-medium text-slate-400">Solutions</h3>
                <ul role="list" className="mt-4 space-y-2">
                    {navigation.solutions.map((item) => (
                    <li key={item.name}>
                        <a href={item.href} className="text-base text-slate-500 hover:text-slate-400">
                        {item.name}
                        </a>
                    </li>
                    ))}
            ...
            <h3 className="text-base font-medium text-slate-400">Language &amp; Currency</h3>
        ...
        <div className="border-t border-slate-700 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
            <div>
            <h3 className="text-base font-medium text-slate-300">Subscribe to our newsletter</h3>
        ...
        <div className="mt-8 border-t border-slate-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-slate-500 md:order-1 md:mt-0">
