...
const Pager = (props) => {
  ...
  const cls = cn(prefixCls, isActivePage ? 'text-primary-500 bg-primary-200/70 dark:bg-dark-palette-100 ring-2 rounded ring-primary-500/50 dark:ring-primary-500/80 z-50 font-semibold' : 'border-light-palette-300 bg-white dark:bg-dark-palette-800 dark:border-dark-palette-600 hover:bg-light-palette-50', `${prefixCls}-${props.page} h-10 shadow border text-sm relative z-10 inline-flex items-center px-4 overflow-hidden first:rounded-l cursor-pointer focus:z-20 select-none`, {
