...
const Button: React.FC<ButtonProps> = forwardRef((props, buttonRef) => {
 ...
 // 
  const rootClassName = cn(
    ...
    { ['h-7 max-h-7 text-xxs font-normal']: !iconOnly && size === '2xs' },
    { ['h-8 max-h-80 text-xs font-normal']: !iconOnly && size === 'xs' },
    { ['h-9 max-h-9 text-sm font-normal']: !iconOnly && size === 'sm' },
    { ['h-11 max-h-11 text-sm font-normal']: !iconOnly && size === 'md' },
    { ['h-12 max-h-12 text-md font-normal']: !iconOnly && size === 'lg' },
    { ['h-13 max-h-13 text-lg font-normal']: !iconOnly && size === 'xl' },
    { ['h-14 max-h-14 text-lg font-normal']: !iconOnly && size === '2xl' },
    { ['h-16 max-h-16 text-lg font-normal']: !iconOnly && size === '3xl' },
    ...
    { ['px-5']: !iconOnly && !icon && size === 'md' },
    { ['px-5']: !iconOnly && !icon && size === 'lg' },
    { ['px-5']: !iconOnly && !icon && size === 'xl' },
    { ['px-6']: !iconOnly && !icon && size === '2xl' },
    { ['px-7']: !iconOnly && !icon && size === '3xl' },
